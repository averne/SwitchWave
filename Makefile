...
FLAGS                   :=  -Wall -Wextra -pipe -g -O2 -ffunction-sections -fdata-sections
CFLAGS                  :=  -std=gnu11
CXXFLAGS                :=  -std=gnu++20 -fno-rtti -fno-exceptions
ASFLAGS                 :=
LDFLAGS                 :=  -Wl,--gc-sections -Wl,-pie -specs=$(DEVKITPRO)/libnx/switch.specs -g
LINKS                   :=  -lnx
...
FLAGS                   :=  -Wall -Wextra -pipe -O0 -ffunction-sections -fdata-sections
CFLAGS                  :=  -std=gnu11
CXXFLAGS                :=  -std=gnu++20 -fno-rtti -fno-exceptions
ASFLAGS                 :=
LDFLAGS                 :=  -Wl,--gc-sections -s -Wl,-pie
LINKS                   :=
PREFIX                  :=
else
